...
mongoose.connect(
  "mongodb+srv://blog:srujan123@cluster0.u4epzjv.mongodb.net/?retryWrites=true&w=majority"
);
  ...
  if (userDoc === null) {
    ...
    if (passOk) {
      ...
      jwt.sign({ username, id: userDoc.id }, secret, {}, (err, token) => {
        //creating a jwt token which takes the payload,private key
        if (err) throw err;
